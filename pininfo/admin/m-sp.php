          ...
          <div class="card">
            <div class="card-body">
              ...
              while ($row = mysqli_fetch_array($result)) {
                ...
                echo "<a href=\"viewpagesp.php?id=$id\" class = \"btn btn-success\">View</a>";
                echo "</td>";

                echo "<td class=\"text-center align-middle\">";
                echo "<a href=\"deletesp.php?id=$id\" class = \"btn btn-danger\" >Delete</a>";
                echo "</td>";
