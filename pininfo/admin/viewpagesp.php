                ...
                <div class="col-xl-4">
                    ...
                    <div class="card">
                        <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                            ...
                            $sql = "SELECT * FROM `tblsp` WHERE `id` = '$userid'";
                                ...
                                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                    ...
                                    <form class="needs-validation" method="post" action="" id="form1" name="form1"
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            if (isset($_POST['uploadbtn'])) {
                                                ...
                                                if (file_exists("../image/spphotos/" . $_FILES['file']['name'])) {
                                                    ...
                                                    include ('dbcon.php');
                                                    $sql = "UPDATE `tblsp` SET `profilephoto` = '$i' WHERE id = $userid";
                                        ...
                                        if (isset($_POST['rbtn'])) {
                                            ...
                                            include ('dbcon.php');
                                            $sql2 = "UPDATE `tblsp` SET `username` = '$nusername' ,`name` = '$nname',`email` = '$nemail',`birthdate` = '$nbirthdate',`gender` = '$ngender',`city` = '$ncity',`state` = '$nstate',`address` = '$naddress',`pincode` = '$npincode',`mobileno` = '$nmobile' WHERE `id` = '$userid'";
                                    ...
                                    <form id="form2" name="form2" method="post" action="" class="needs-validation">
                                        ...
                                        if (isset($_POST["passsubmitbtn"])) {
                                            ...
                                            if ($pass == $currentpass) {
                                                if ($npass == $cpass) {
                                                    include ("dbcon.php");
                                                    $sql2 = "UPDATE `tblsp` SET `password` = '$npass' WHERE `id` = '$userid'";
