...
adheres to [Semantic Versioning](https://semver.org/spec/v2.0.0.php),
...
- New `getTransparentElements` function added to `tinymce.php.Schema` to return a map object of transparent HTML elements. #TINY-9172
...
- Removed the `shortEnded` and `fixed` properties on `tinymce.php.Node` class. #TINY-8205
