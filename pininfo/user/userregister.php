            ...
            <div class="col-lg-8 col-md-8 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <!-- Multi Columns Form -->
                  <form class="row g-3 needs-validation" id="form1" method="POST" name="form1"
                    enctype="multipart/form-data">

                    <div class="col-md-4">
                      <div class="form-floating">
                        <input type="text" class="form-control" id="fnameplace" name="fnameplace"
                    ...
                    <div class="col-md-4">
                      <div class="form-floating">
                        <input type="text" class="form-control" id="lnameplace" name="lnameplace"
                          placeholder="Your Name">
                    ...
                    <div class="col-md-4">
                      <div class="form-floating">
                        <input type="email" class="form-control" id="emailplace" name="emailplace"
                          placeholder="Your Name">
